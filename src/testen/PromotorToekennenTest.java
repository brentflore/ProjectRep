...
public class PromotorToekennenTest {
   ...
   private Promotor geselecteerdePromotor2;
   ...
   private int maxStudenten;
    ...
    public void before() {
        ...
        geselecteerdePromotor= new Promotor("Iemand","da",promnr,0);
    }
...
//      cc.voegStudentToeNaMax(geselecteerdeStudent);
      cc.update(cc, geselecteerdeStudent);
    //  cc.koppelPromotorEnGeselecteerdeStudenten(geselecteerdePromotor2);
  }
